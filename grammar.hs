...
happyExpList = Happy_Data_Array.listArray (0,48) ([33536,2,49156,160,0,1920,512,0,0,0,0,0,32896,0,8192,32800,0,4,32,256,0,8,0,0,0,12288,32768,1,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_impParser","Expr","Aexpr","Bexpr","Num","Boo","int","bool","'='","'+'","'-'","'*'","'/'","'('","')'","'!'","%eof"]
        bit_start = st * 19
        bit_end = (st + 1) * 19
...
action_2 (16) = happyShift action_2
...
impParser tks = happyRunIdentity happySomeParser where
